...
const createNewIterator = require('../src/create-new-iterator')
...
function* increaseRange (a, b) {
    for (let i = a; i <= b; ++i) {
        yield i
    }
}

function* decreaseRange (a, b) {
    for (let i = a; i >= b; --i) {
        yield i
    }
}
